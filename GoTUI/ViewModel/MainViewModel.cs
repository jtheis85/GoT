...
namespace GoTUI.ViewModel
{
  ...
  public class MainViewModel : ViewModelBase
  {
    ...
    public MainViewModel(IDataService dataService)
    {
      ...
      Regions.Add(new Region() { Name = "The North",
                                 Margin = new System.Tuple<int,int,int,int>(50,62,148,228),
      ...
      Regions.Add(new Region() { Name = "The South",
                                 Margin = new System.Tuple<int, int, int, int>(148, 1746, 219, 143),
